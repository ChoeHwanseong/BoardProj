...
public class PagingUtil {
	 ...
	 * 				PAGE_SIZE,BLOCK_PAGE는 맵에 설정해야 한다.
	...
	public static int getNowPage(int rank, HttpServletRequest req ) {
		int nowPage = rank/Integer.parseInt(req.getServletContext().getInitParameter("BLOCK-PAGE"));
		if(rank%Integer.parseInt(req.getServletContext().getInitParameter("BLOCK-PAGE"))!=0) nowPage+=1;
		return nowPage;
	}
}
